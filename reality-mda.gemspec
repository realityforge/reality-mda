...
Gem::Specification.new do |s|
  ...
  s.homepage           = %q{https://github.com/realityforge/reality-mda}
  s.summary            = %q{The glue that blends reality-core, reality-model, reality-generators and reality-facets into an model driven application.}
  s.description        = %q{The glue that blends reality-core, reality-model, reality-generators and reality-facets into an model driven application.}
